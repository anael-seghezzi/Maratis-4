...
public:
	...
	*/
	...
	int QueryUIntValue( unsigned int* ival ) const;
...
public:
	...
	*/	
	...
	int QueryUIntAttribute( const char* name, unsigned int* _value ) const;
	...
	*/
	...
	int QueryUIntAttribute( const std::string& name, unsigned int* _value ) const;
